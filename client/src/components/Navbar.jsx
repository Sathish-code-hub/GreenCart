                ...
                </div>
              {
                  !user ? (
                      ...
                      <div className="relative group">
                          ...
                          {/* Dropdown on hover */}
                          <div className="absolute -right-4  w-40 bg-white border border-gray-200 rounded-md shadow-md opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-opacity duration-200 z-50">
